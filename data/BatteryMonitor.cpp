...
void BatteryMonitor::update() {
    ...
    uint16_t raw = analogRead(_config.pin);
    // This is the voltage measured at the ADC pin
    float v_out = (raw / (float)_config.adcResolution) * _config.vRef;
    // Apply the voltage divider formula backwards to find the source voltage
